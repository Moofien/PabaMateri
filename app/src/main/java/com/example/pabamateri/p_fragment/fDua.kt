...
class fDua : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val btnOpenFSatuFromDua = view.findViewById<Button>(R.id.btnOpenFDua)
        ...
        if (namaDiterima != "") {
            tvHasil.text = "Hello, $namaDiterima! Alamat Anda $alamatDiterima"
        }

        btnOpenFSatuFromDua.setOnClickListener {
            (requireActivity() as FragmentActivity).replaceFragment(fSatu())
        }
    }
    companion object {
        /**
